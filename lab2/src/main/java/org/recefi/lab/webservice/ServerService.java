 ...
 * 
 */
@WebServiceClient(name = "ServerService", targetNamespace = "http://server.lab.recefi.org/", wsdlLocation = "http://localhost:7474/Connect6?wsdl")
    ...
    extends Service
{
    ...
    private final static QName SERVERSERVICE_QNAME = new QName("http://server.lab.recefi.org/", "ServerService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:7474/Connect6?wsdl");
    ...
    public Server getServerPort() {
        return super.getPort(new QName("http://server.lab.recefi.org/", "ServerPort"), Server.class);
    }
    ...
    public Server getServerPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://server.lab.recefi.org/", "ServerPort"), Server.class, features);
    }
